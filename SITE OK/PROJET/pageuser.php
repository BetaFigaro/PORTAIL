...
<?php
    ...
    // Vérifie si la variable de session pour l'heure de dernière activité existe
    if (isset($_SESSION['last_activity']) && (time() - $_SESSION['last_activity']) > $timeout_duration) {
        // Si le temps d'inactivité dépasse la limite, déconnecte l'utilisateur
        session_unset();
        session_destroy();
...
<body>
    ...
    <div class="center-content">
        ...
        <?php
        echo '<button class="bouton" onclick="publication_OUVERTURE()">OUVERTURE DU PORTAIL</button>'; //bouton d'ouverture
        ?>
